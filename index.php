...
<nav class='navbar fixed-top navbar-expand-lg navbar-dark scrolling-navbar'>
    <div class='container'>
      <a class='navbar-brand text-danger' href='index.php'><strong>Toko Potato</strong></a>
      ...
      <div class='collapse navbar-collapse' id='navbarSupportedContent'>
        <ul class='navbar-nav mr-auto'>
          <li class='nav-item'>
            <a class='nav-link text-primary' href='../toko_potato/barang/index.php'>Barang</a>
          </li>
          <li class='nav-item'>
            <a class='nav-link text-primary' href='../toko_potato/faktur/index.php'>Pelanggan</a>
          </li>
          <li class='nav-item'>
            <a class='nav-link text-primary' href='../toko_potato/penjualan/index.php'>Penjualan</a>
          </li>
        </ul>
      </div>
    </div>
